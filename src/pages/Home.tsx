    ...
    return (
        <div className="bg-transparent min-h-screen text-white overflow-hidden">
            ...
            <section className="relative w-full h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-grey/60 via-transparent to-grey/80 z-0"></div>
                ...
                <div className="container relative z-10 text-center px-4">
                    ...
                    >
                        <h1 className="text-5xl md:text-7xl lg:text-[9rem] font-cursive text-white mb-6 tracking-wider leading-none">
                            <span className="relative z-10"><img src={logo} alt="Gyaviira Logo" className="h-32 md:h-48 lg:h-72 border-transparent drop-shadow-[0_0_20px_rgba(212,175,55,0.3)]" /></span>
                            <motion.span
