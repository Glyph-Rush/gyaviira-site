...
const Checkout: React.FC = () => {
    ...
    if (step === 'success') {
        return (
            <div className="pt-32 pb-20 min-h-screen bg-transparent flex flex-col items-center justify-center px-6">
                <motion.div
    ...
    return (
        <div className="pt-32 pb-20 min-h-screen bg-transparent overflow-x-hidden">
