...
import rise_grind from '../assets/rise_grind.png';
import hoodie1 from '../assets/hoodie_1.png';

type Category = 'All' | 'Outerwear' | 'Head' | 'Shirts' | 'Instruments' | 'Bundles';

const products = [
    { id: 1, name: 'Black Hoodie', price: 55000, image: hoodie2, category: 'Outerwear', description: 'Gold-embroidered heavy cotton, built for the resilient spirit.' },
    { id: 2, name: 'Signature Gold Cap', price: 13000, image: cap1, category: 'Head', description: 'The official headwear of the Gyaviira legacy.' },
    { id: 3, name: 'Member T-Shirt', price: 23000, image: shirt2, category: 'Shirts', description: 'Premium cotton tee featuring the foundation emblem.' },
    { id: 4, name: 'Rise & Grind', price: 100000, image: rise_grind, category: 'Bundles', isDigital: true, isBundle: true, description: 'Limited Edition Bundle: Vinyl + Hoodie + Signed Poster.', isPreorder: true },
    { id: 5, name: 'Premium White Hoodie', price: 60000, image: hoodie1, category: 'Outerwear', isPremium: true, isPreorder: true, description: 'Premium white hoodie signed by the Founder:Jerome Gyaviira .M.' },
];
            ...
            <div className="container mx-auto px-6">
                ...
                >
                    ...
                    <div className="flex flex-wrap justify-center gap-4">
                        {['All', 'Instruments', 'Outerwear', 'Head', 'Shirts', 'Bundles'].map((category) => (
                            <button
                                key={category}
                                ...
                                <div className="aspect-square bg-gradient-to-br from-[#1a1a1a] to-[#0d0d0d] p-8 flex items-center justify-center relative overflow-hidden">
                                    ...
                                    <div className="absolute top-4 left-4 z-30 flex flex-col gap-2">
                                        ...
                                        {(product as any).isPremium && (
                                            <span className="bg-black-soft text-gold text-[8px] font-bold px-3 py-1 rounded-full shadow-lg tracking-widest  font-bondoi mt">PREMIUM</span>
                                        )}
                                    </div>
                                </div>
