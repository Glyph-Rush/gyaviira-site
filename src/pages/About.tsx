...
const About: React.FC = () => {
    ...
    return (
        <div className="bg-transparent min-h-screen text-white overflow-hidden">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 justify-items-center">
                            ...
                            >
                                <div className="w-full aspect-[3/4] bg-[#0a0a0a] border-2 border-gold-primary/20 rounded-2xl relative flex items-center justify-center overflow-hidden shadow-2xl transition-all duration-700 group-hover/frame:border-gold-primary group-hover/frame:shadow-[0_0_50px_rgba(212,175,55,0.2)]">
                                    ...
                                    <div className="absolute bottom-0 w-full p-6 bg-gradient-to-t from-black to-transparent">
                                        <h3 className="text-xl font-bold text-white tracking-widest text-center mb-1">JEROME MOSES</h3>
                                        <h3 className="text-sm font-impact text-gold-primary tracking-widest text-center uppercase">FOUNDER & CEO</h3>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            >
                                <div className="w-full aspect-[3/4] bg-[#0a0a0a] border-2 border-gold-primary/20 rounded-2xl relative flex items-center justify-center overflow-hidden shadow-2xl transition-all duration-700 group-hover/frame:border-gold-primary group-hover/frame:shadow-[0_0_50px_rgba(212,175,55,0.2)]">
                                    ...
                                    <div className="absolute bottom-0 w-full p-6 bg-gradient-to-t from-black to-transparent">
                                        <h3 className="text-xl font-bold text-white tracking-widest text-center mb-1">CHRIS NSHUTI</h3>
                                        <h3 className="text-sm font-impact text-gold-primary tracking-widest text-center uppercase">CO-FOUNDER & MANAGER</h3>
                                    </div>
                                </div>
                            </motion.div>
                        </div>
