...
const KNOWLEDGE_BASE = [
    ...
    { keys: ['founder', 'who started', 'ceo', 'manager'], response: "The Foundation was established by visionary leadership to honor a legacy of music and faith. You can find more about our Founders on the About page.", action: '/about' },
    ...
    // Contact
    { keys: ['contact', 'email', 'reach', 'talk'], response: "You can reach us via email at jeromemoses220@gmail.com or connect with us on Instagram.", action: '/contact' },
    { keys: ['social', 'instagram', 'insta'], response: "Follow our journey on Instagram @gyav.iira.", action: '/contact' },
];
...
const RhythmChat: React.FC = () => {
    ...
    const [messages, setMessages] = useState<Message[]>([
        {
            id: 1,
            text: "System Online. I am Rhythm. Fully autonomous mode active. Type /help for basic info or /cmd to see all 40+ commands.",
            sender: 'bot',
            timestamp: new Date()
        }
    ]);
    ...
    const simulateResearch = (input: string) => {
        setIsTyping(true);
        const steps = [
            "Initializing deep scan of Gyaviira archives...",
            "Analyzing semantic intent and cross-referencing values...",
            "Querying real-time foundation database...",
            "Synthesizing autonomous response..."
        ];
